...
@section("content")
    <div class="font-sans text-gray-900 antialiased">
        <div class="min-h-screen w-full flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-[#f8f4f3]">
            <form method="POST" action="{{ route('ghazwanForm.admin.user.add') }}" class="w-full">
                @csrf
                <div class="p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-1 gap-6 px-8">
                    <div class="mt-4">
                        ...
                        <input type="text" name="ghazwanNik" placeholder="NIK"
                    ...
                    <div class="mt-4">
                        ...
                        <input type="text" name="ghazwanName" placeholder="Nama Anda"
                            class="w-full rounded-md py-2.5 px-4 border text-sm outline-[#f84525]" />
                    </div>
