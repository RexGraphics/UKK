                                                ...
                                                <div class="p-6 space-y-6">
                                                    <div class="flex gap-6">
                                                        ...
                                                        <div class="w-2/5 flex flex-col">
                                                            <div class="h-64 overflow-y-auto border border-gray-300 rounded-lg mb-2 p-2">
                                                                <div class="mb-2">
                                                                    <div class="text-sm text-gray-600 bg-gray-100 p-2 rounded-lg inline-block">
                                                                        <div>{{}}/div>
                                                                        Pesan dari masyarakat
                                                                    </div>
                                                                </div>
                                                                <div class="mb-2 text-right">
                                                                    <div class="text-sm text-gray-600 bg-blue-100 p-2 rounded-lg inline-block">
                                                                        Balasan dari petugas
                                                                    </div>
                                                                </div>
                                                            </div>

                                                            <input type="text" name="ghazwanTanggapan"
                                                                id="ghazwanTanggapan"
                                                                class="block w-full p-2 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500"
                                                                placeholder="Tulis tanggapan Anda di sini...">
                                                            <input type="hidden" name="ghazwanIdPengaduan"
                                                                value="{{ $value->id_pengaduan }}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="p-4 bg-white rounded-lg mt-6">
                                                        <div class="flex flex-wrap items-center gap-6 mb-4">
                                                            <div class="flex items-center">
                                                                <input type="radio" id="ghazwanStatusPending"
                                                                    name="ghazwanStatus" value="pending"
                                                                    class="w-4 h-4 border-gray-300 text-yellow-500 focus:ring-yellow-500">
                                                                <label for="ghazwanStatusPending"
                                                            ...
                                                            <div class="flex items-center">
                                                                <input type="radio" id="ghazwanStatusProses"
                                                                    name="ghazwanStatus" value="proses"
                                                                    class="w-4 h-4 border-gray-300 text-blue-500 focus:ring-blue-500">
                                                                <label for="ghazwanStatusProses"
                                                                    class="ml-2 text-sm font-medium text-gray-700">
                                                                    Proses
                                                                </label>
                                                            </div>
                                                            ...
                                                            <div class="flex items-center">
                                                                <input type="radio" id="ghazwanStatusSelesai"
                                                                    name="ghazwanStatus" value="selesai"
                                                                    class="w-4 h-4 border-gray-300 text-green-500 focus:ring-green-500">
                                                                <label for="ghazwanStatusSelesai"
                                                                    class="ml-2 text-sm font-medium text-gray-700">
                                                                    Selesai
                                                                </label>
                                                            </div>
