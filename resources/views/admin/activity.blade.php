        ...
        <div class="h-auto w-full flex flex-col mt-24 items-center pt-6 sm:pt-0 bg-[#f8f4f3] pb-8">
            <div class="w-[95%] flex justify-between items-center mb-4">
                <form method="GET" class="flex items-center gap-2">
                    ...
                    <label for="ghazwanSearch" class="text-sm text-gray-700">Cari Aktivitas</label>
                    <input type="text" name="ghazwanSearch" id="ghazwanSearch"
                        class="border border-gray-300 text-sm rounded-lg p-2">
                    <button type="submit"
                    ...
                    @endif
                        @foreach ($ghazwanActivity as $activity)
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td class="px-6 py-4">
                                    @foreach($ghazwanPetugas as $data)
                                    {{ $activity->causer_id == $data->id_petugas ? $data->nama_petugas :'' }}
                                    @endforeach
                                </td>
            ...
            <div class="flex w-full items-center justify-between border-t border-gray-200 px-4 py-3 sm:px-6">
                ...
                <div class="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
                    <div
                        class="flex flex-col sm:flex-row items-center justify-between border-t border-gray-200 px-4 py-3 sm:px-6 w-full">
